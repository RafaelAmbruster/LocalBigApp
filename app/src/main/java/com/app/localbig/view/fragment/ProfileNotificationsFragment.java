...
import com.app.localbig.model.Notification;
import com.app.localbig.view.adapter.NotificationAdapter;
...
public class ProfileNotificationsFragment extends BaseFragment implements View.OnClickListener{
    ...
    public static ProfileNotificationsFragment newInstance(ApplicationUser us) {
