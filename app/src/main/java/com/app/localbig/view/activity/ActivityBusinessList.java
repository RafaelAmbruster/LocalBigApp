...
import com.app.localbig.view.search.SearchBox;
import com.app.localbig.view.search.SearchResult;
...
public class ActivityBusinessList extends AbstractActivity implements ResponseObjectCallBack,
    ...
    public static ArrayList<Business> searchbusinesses;
    ...
    protected void Load() {
        ...
        sbSearch = (SearchBox) findViewById(R.id.psApp_bar_search);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        getMenuInflater().inflate(R.menu.menu_search_business_offline, menu);
        ...
        businessObservable.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Subscriber<List<Business>>() {
                    ...
                    public void onNext(List<Business> result) {
                        searchbusinesses = (ArrayList<Business>) result;
                        LogManager.getInstance().info("searchbusinesses", searchbusinesses.size() + "");
                        if (!previous_term.equals(searchTerm)) {
                            for (Business item : searchbusinesses) {
