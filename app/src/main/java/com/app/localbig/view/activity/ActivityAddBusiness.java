...
public class ActivityAddBusiness extends AbstractActivity implements
    ...
    private ArrayList<BusinessCategory> filtercategories;
    private ArrayList<BusinessPicture> images;
    ...
    private void Load() {
        ...
        business_category.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        business_address_description = (TextView) findViewById(R.id.business_address_description);
        business_address_description.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        business_description = (TextView) findViewById(R.id.business_description);
        business_description.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        business_information = (TextView) findViewById(R.id.business_information);
        business_information.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        business_picture = (TextView) findViewById(R.id.business_picture);
        business_picture.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        business_start_date_dec = (TextView) findViewById(R.id.business_start_date_desc);
        business_start_date_dec.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));

        direction = (EditText) findViewById(R.id.business_direction);
        direction.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));

        phonenumber = (EditText) findViewById(R.id.phone);
        phonenumber.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        phonenumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                if (validatePhone(s.toString())) {
                    ...
                    phoneWrapper.setError("Invalid phone number must be in format xxx-xxx-xxxx");
                }
            }
        });

        website = (EditText) findViewById(R.id.web);
        website.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        website.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                                      int before, int count) {
                if (validateURL(s.toString())) {
                    websiteWrapper.setErrorEnabled(false);
                } else {
        ...
        tittle.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        ...
        description.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        ...
        tittleWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        descriptionWrapper = (TextInputLayout) findViewById(R.id.descriptionWrapper);
        descriptionWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        directionWrapper = (TextInputLayout) findViewById(R.id.directionWrapper);
        directionWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        phoneWrapper = (TextInputLayout) findViewById(R.id.phoneWrapper);
        phoneWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        websiteWrapper = (TextInputLayout) findViewById(R.id.webWrapper);
        websiteWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        ...
        pick_start_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                datestart = true;
                getDate("PICK START BUSINESS DATE");
            }
        });
        ...
        pick_start_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timestart = true;
                getTime("PICK START BUSINESS TIME");
            }
        });

        tvDayOfWeek = (TextView) parent_view.findViewById(R.id.widget_details_header_dayofweek);
        tvDayOfWeek.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        ...
        tvMonthAndYear.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddBusiness.this));
        ...
        business_video_url = (EditText) findViewById(R.id.business_video_url);
        Button pickerVideo = (Button) findViewById(R.id.add_video_url);
        pickerVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showAddYoutubeVideoURL();
            }
        });
        ...
        new MaterialDialog.Builder(this)
                ...
                .itemsCallbackSingleChoice(2, new MaterialDialog.ListCallbackSingleChoice() {
                    ...
                    public boolean onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                        ...
                        filtercategories.add(new BusinessCategoryDAO(AppDatabaseManager.getInstance().getHelper()).getBusinessCategoryByDescription(categories[which]));
    ...
    private void Create() {
        ...
        business.setSinceDate(CustomDateFormat.getCurrentDateTime(startDate.getTime()));
        business.setPhoneNumber(phonenumber.getText().toString().trim());
        business.setWebSiteUrl(website.getText().toString().trim());
        business.setFormattedAddress(place.getAddress().toString());
        business.setLatitude(String.valueOf(place.getLatLng().latitude));
        business.setLongitude(String.valueOf(place.getLatLng().longitude));
        business.setApplicationUserId(us.getId());
        business.setBusinessCategory(filtercategories.get(0));
    ...
    public void onResponseObjectCallBack(Object object) {
        ...
        if (object instanceof BusinessResponse) {
            BusinessResponse response = (BusinessResponse) object;
            String businessId = response.getBusiness().getId();
            if (thumbnails.size() > 0) {

                for (String item : thumbnails) {
                    BusinessPicture pi = new BusinessPicture();
    ...
    private void CreateImages(final ArrayList<BusinessPicture> pictures) {
