...
public class ActivityEventList extends AbstractActivity implements
    ...
    public static ArrayList<LocalEvent> events;
    ...
    protected void Load() {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(ActivityEventList.this);
    ...
    private void calculatePoiDistances() {
        if (mLocation != null && events != null && events.size() > 0) {
    ...
    private void SetupAdapter() {
        ...
        adapter = new EventAdapter(ActivityEventList.this, recyclerView, new EventAdapter.OnItemClickListener() {
            @Override
    ...
    protected void Run(boolean process) {
        if (Tools.isOnline(ActivityEventList.this, true, false)) {
    ...
    private void startEventDetail(LocalEvent object) {
        Intent intent = new Intent(ActivityEventList.this, ActivityEventsDetails.class);
        Bundle b = new Bundle();
        Gson gSon = new Gson();
    ...
    private void setupTimer() {
        ...
        mTimerRunnable = new Runnable() {
            ...
            public void run() {
                ...
                mGeolocation = null;
                mGeolocation = new Geolocation((LocationManager) getSystemService(Context.LOCATION_SERVICE), ActivityEventList.this);
