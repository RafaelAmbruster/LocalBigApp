...
public class ProfileBusinessFragment extends BaseFragment implements View.OnClickListener, ResponseObjectCallBack {
    ...
    public static ProfileBusinessFragment newInstance(ApplicationUser us) {
