...
public class ReviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private List<Review> original_items = new ArrayList<>();
    private List<Review> filtered_items = new ArrayList<>();
    ...
    public class ReviewViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(final Review c, final int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Review> list = original_items;
            final List<Review> result_list = new ArrayList<>(list.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Review>) results.values;
            notifyDataSetChanged();
        }
    }
