...
public class CouponAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private List<Coupon> original_items = new ArrayList<>();
    private List<Coupon> filtered_items = new ArrayList<>();
    ...
    public class CouponViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(final Coupon c, final int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Coupon> list = original_items;
            final List<Coupon> result_list = new ArrayList<>(list.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Coupon>) results.values;
            notifyDataSetChanged();
        }
    }
