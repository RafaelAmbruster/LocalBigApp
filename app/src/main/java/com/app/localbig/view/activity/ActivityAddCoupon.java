...
public class ActivityAddCoupon extends AbstractActivity implements
    ...
    private EditText discount, description;
    ...
    private SwitchCompat isActive,inPercent;
    private TextInputLayout discountWrapper;
    ...
    private TextView coupon_description, coupon_information, coupon_picture, coupon_is_active, coupon_start_date_dec, coupon_start_date_dec_end, coupon_percent;
    ...
    private void Load() {
        ...
        coupon_description.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_information = (TextView) findViewById(R.id.coupon_information);
        coupon_information.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_picture = (TextView) findViewById(R.id.coupon_picture);
        coupon_picture.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_is_active = (TextView) findViewById(R.id.coupon_active);
        coupon_is_active.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_start_date_dec = (TextView) findViewById(R.id.coupon_start_date_desc);
        coupon_start_date_dec.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_start_date_dec_end = (TextView) findViewById(R.id.coupon_start_date_desc_end);
        coupon_start_date_dec_end.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        coupon_percent = (TextView) findViewById(R.id.coupon_percent);
        coupon_percent.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));

        description = (EditText) findViewById(R.id.description);
        description.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        ...
        discount.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        discount.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                                      int before, int count) {
                if (!validate(s.toString())) {
                   discountWrapper.setErrorEnabled(false);
                }
            }
        });

        isActive = (SwitchCompat) findViewById(R.id.is_active);
        inPercent = (SwitchCompat) findViewById(R.id.is_inpercent);

        mPatio = (Patio) findViewById(R.id.patio);
        mPatio.setCallbacksListener(this);

        discountWrapper = (TextInputLayout) findViewById(R.id.discountWrapper);
        discountWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        descriptionWrapper = (TextInputLayout) findViewById(R.id.descriptionWrapper);
        descriptionWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        ...
        pick_start_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                datestart = true;
                dateend = false;
                getDate("PICK START COUPON DATE");
            }
        });
        ...
        pick_start_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timestart = true;
                timeend = false;
                getTime("PICK START COUPON TIME");
            }
        });
        ...
        pick_end_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timestart = false;
                timeend = true;
                getTime("PICK END COUPON TIME");
            }
        });

        tvDayOfWeek = (TextView) parent_view.findViewById(R.id.widget_details_header_dayofweek);
        tvDayOfWeek.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        ...
        tvMonthAndYear.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        ...
        tvDayOfWeekE.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
        ...
        tvMonthAndYearE.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(ActivityAddCoupon.this));
    ...
    private void setupTimer() {
        ...
        mTimerRunnable = new Runnable() {
            ...
            public void run() {
                ...
                mGeolocation = null;
                mGeolocation = new Geolocation((LocationManager) getSystemService(Context.LOCATION_SERVICE), ActivityAddCoupon.this);
    ...
    private void Create() {
        ...
        if (validate(description.getText().toString())) {
            showMessage("Please, add a description for your coupon");
        ...
        if (thumbnails.size() == 0) {
            showMessage("The coupon must have at least one picture");
            return;
        }

        coupon = new Coupon();
        coupon.setDescription(description.getText().toString().trim());
        coupon.setActive(isActive.isChecked());
        coupon.setStartDate(CustomDateFormat.getCurrentDateTime(startDate.getTime()));
        coupon.setEndDate(CustomDateFormat.getCurrentDateTime(endDate.getTime()));
        coupon.setBusinessId(business.getId());
        coupon.setPlaceOrBusiness(business.getTitle());
        coupon.setDiscount(Double.parseDouble(discount.getText().toString().trim()));
        coupon.setInPercent(inPercent.isChecked());

        for (String item : thumbnails) {
            File picfile = new File(item);
            String filename = picfile.getName();
            String pic = Tools.CompressImage(item, ActivityAddCoupon.this);
            coupon.setImageBase64(pic);
            coupon.setImageFileName(filename);
        }

        ShowProgress("Please wait");
        new CouponTask(this).CallService(3, "", coupon);
    }
    ...
    public void initActionbar() {
        ...
        tittle.setText("CREATE NEW COUPON");
    ...
    private void renderViewMap(LatLng latLng) {
        ...
        Picasso.with(ActivityAddCoupon.this)
    ...
    public void onResponseObjectCallBack(Object object) {
        showMessage("Coupon created succesfully");
        Close();
    }
