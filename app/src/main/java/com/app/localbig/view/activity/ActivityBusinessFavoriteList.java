...
import com.app.localbig.view.adapter.BusinessAdapter;
...
public class ActivityBusinessFavoriteList extends AbstractActivity implements ResponseObjectCallBack,
    ...
    public void initActionbar() {
        ...
        tittle.setText("FAVORITE BUSINESSES");
    ...
    protected void Load() {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(ActivityBusinessFavoriteList.this);
    ...
    private void SetupAdapter() {
        ...
        adapter = new BusinessAdapter(ActivityBusinessFavoriteList.this, recyclerView, new BusinessAdapter.OnItemClickListener(){
            @Override
    ...
    protected void Run(boolean process) {
        if (Tools.isOnline(ActivityBusinessFavoriteList.this, true, false)) {
    ...
    private void LoadFavoriteList() {
        ...
        Call<List<UserFavoriteBusiness>> call = apiService.getBusinessFavorites(us.getId());
    ...
    private void LoadFavoriteBusiness(final List<UserFavoriteBusiness> events) {
        ApiInterface apiService =
                ServiceGenerator.createService(ApiInterface.class);
        count = 1;
        for (UserFavoriteBusiness item : events) {
    ...
    private void setupTimer() {
        ...
        mTimerRunnable = new Runnable() {
            ...
            public void run() {
                ...
                mGeolocation = null;
                mGeolocation = new Geolocation((LocationManager) getSystemService(Context.LOCATION_SERVICE), ActivityBusinessFavoriteList.this);
    ...
    private void startBusinessDetail(Business business) {
        Intent intent = new Intent(ActivityBusinessFavoriteList.this, ActivityBusinessDetails.class);
        Bundle b = new Bundle();
        Gson gSon = new Gson();
