...
import com.app.localbig.rest.task.account.RegistrationTask;
import com.app.localbig.rest.task.account.ResponseRegisterCallBack;
import com.dd.processbutton.iml.ActionProcessButton;

public class SignupActivity extends AppCompatActivity implements ResponseRegisterCallBack {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _nameText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _lastText = (EditText) findViewById(R.id.input_last);
        _lastText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _emailText = (EditText) findViewById(R.id.input_email);
        _emailText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _mobileText = (EditText) findViewById(R.id.input_mobile);
        _mobileText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _passwordText = (EditText) findViewById(R.id.input_password);
        _passwordText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _reEnterPasswordText = (EditText) findViewById(R.id.input_reEnterPassword);
        _reEnterPasswordText.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _signupButton = (ActionProcessButton) findViewById(R.id.btn_signup);
        _signupButton.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        _loginLink = (TextView) findViewById(R.id.link_login);

        nameWrapper = (TextInputLayout) findViewById(R.id.nameWrapper);
        nameWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        lastWrapper = (TextInputLayout) findViewById(R.id.lastWrapper);
        lastWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        emailWrapper = (TextInputLayout) findViewById(R.id.emailWrapper);
        emailWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        mobileWrapper = (TextInputLayout) findViewById(R.id.mobileWrapper);
        mobileWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        passwordWrapper = (TextInputLayout) findViewById(R.id.passwordWrapper);
        passwordWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
        repasswordWrapper = (TextInputLayout) findViewById(R.id.repasswordWrapper);
        repasswordWrapper.setTypeface(FontTypefaceUtils.getRobotoCondensedLight(SignupActivity.this));
    ...
    @Override
    public void onResponseRegisterCallBack(final AccountRegistrationResponse response) {
