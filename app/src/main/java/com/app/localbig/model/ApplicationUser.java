...
@DatabaseTable(tableName = "ApplicationUser")
public class ApplicationUser {
     ...
     * @param roleId
     */
    public ApplicationUser(String id, boolean owner, String formattedAddress, String lastName, String firstName, String roleId, String phoneNumber, String email, String saltedAndHashedPassword, String salt) {
        this.id = id;
        this.owner = owner;
     ...
     *     The localEvents
     */
    public void setLocalEvents(List<LocalEvent> localEvents) {
